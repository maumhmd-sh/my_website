  ...
  <header class="header z-40">
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <RouterLink to="/projects" title="Projects">
          <div i-mdi-account-hard-hat />
        </RouterLink>

        <RouterLink to="/certification" title="Certification">
          <div i-mdi-receipt-text-check-outline />
        </RouterLink>
        <RouterLink to="/gallery" title="Gallery">
          <div i-ri-camera-3-line />
        </RouterLink>
        <RouterLink to="/contact" title="Contact">
          <div i-ri-chat-1-line />
        </RouterLink>
        <a href="https://github.com/maumhmd-sh" target="_blank" title="GitHub" class="lt-md:hidden">
